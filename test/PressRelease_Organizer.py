...
driver.execute_script("window.scrollBy(0,2000)")
#driver.execute_script("window.scrollBy(0,document.body.scrollHeight || document.documentElement.scrollHeight/3"")", "")


driver.implicitly_wait(5)


driver.find_element_by_xpath('//a[contains(@href,"/profile/Selvamary/pressreleases")]').click()
driver.implicitly_wait(5)
...
driver.execute_script("window.scrollBy(0,document.body.scrollHeight || document.documentElement.scrollHeight/3.5"")", "")
